    ...
    <section className={styles.stepTwo}>
      ...
      <div className={styles.stepTwoContainer}>
        <div className={styles.choice}>
          <input name="shippingMethod" className={styles.choiceBox} type="radio" value="on" checked={shippingChange === "on"} onChange={handleChange}/>
        ...
        <div className={styles.choice}>
          <input name="shippingMethod" className={styles.choiceBox} type="radio" value="off" checked={shippingChange === "off"} onChange={handleChange}/>
          <div className={styles.radioInfo}>
            <div className={styles.radioInfoChoice}>
