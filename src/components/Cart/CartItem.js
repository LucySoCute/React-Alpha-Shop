    ...
    <section className={styles.productSection} key={product.id} >
            ...
            <div className={styles.productInfo}>
                ...
                <div className={styles.productControlSection}>
                    <button onClick={()=>handleMinusClick(product.id)}><img className={styles.icon} src={minus} alt="icon-minus" /></button>
                    <span className={styles.productAmount}> {product.quantity} </span>
                    <button onClick={()=>handlePlusClick(product.id)}><img className={styles.icon} src={plus} alt="icon-plus" /></button>
                </div>
            </div>
